...
import end_ofdm_tx_epy_block_0 as epy_block_0  # embedded python block
import sip



class end_ofdm_tx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "end_ofdm_tx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("end_ofdm_tx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "end_ofdm_tx")
        ...
        self.epy_block_0 = epy_block_0.blk(vlen=32, interpolation=32)
        self.blocks_vector_to_stream_0 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, fft_len)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(1/fft_len)
...
def main(top_block_cls=end_ofdm_tx, options=None):
